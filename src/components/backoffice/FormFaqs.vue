    ...
    <form @submit.prevent="">
        ...
        <div class="field is-horizontal" style="margin: 0.5em 0 1.5em 0;">
            ...
            <div class="field-body has-text-grey-lighter">
                <p class="is-size-7">Selecione uma faq existente acima para carregar a pergunta e a resposta
                    ou preencha de raíz os campos abaixo para criar uma nova.</p>
            </div>
        </div>
        <VInput id="ra-faq-question" type="text" label="Pergunta:"
                :value="selectedFaq.question" @input-changed="updateFaqName" />
        <VTextarea id="ra-faq-answer" label="Resposta:" />
