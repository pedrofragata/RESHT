  ...
  >
    ...
    <div id="ra-navbar" class="navbar-menu">
      <div class="navbar-start">
        <router-link
          v-show="!loginStatus.isLogged"
          class="navbar-item is-size-7 is-uppercase"
          to="/login"
        >Login</router-link>
        <div v-show="loginStatus.isLogged" class="navbar-item has-dropdown is-hoverable">
          ...
          >
            <span v-if="loginStatus.loggedUser.avatar == verify " class="icon is-medium">
              <i class="fas fa-2x fa-user-circle"></i>
            </span>
            <span v-else class="icon is-medium">
              <img :src="loginStatus.loggedUser.avatar" />
            </span>
      ...
      <div class="navbar-end">
        ...
        <router-link
          class="navbar-item is-size-7 is-uppercase"
          to="/#ra-bookmark-todays-special"
        >Prato do dia</router-link>
